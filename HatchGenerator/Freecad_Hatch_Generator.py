...
"""
    ...
    def onPreview(self):
        ...
        1) Create a temporary parametric hatch object with the user’s current property settings.
        2) Recompute the doc, so the param object’s .Shape is generated.
